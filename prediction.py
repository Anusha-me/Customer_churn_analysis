...
churn_data = pd.read_csv(
    "C:\Users\aksha\Downloads\Customer-Churn-Analysis-and-Classification-main\Customer-Churn-Analysis-and-Classification-main\tel_churn.csv")
x = churn_data.drop('Churn', axis=1)
y = churn_data['Churn']
x_train, x_test, y_train, y_test = train_test_split(x, y, test_size=0.2)

loaded_model = pickle.load(open(
   "C:\Users\aksha\Downloads\Customer-Churn-Analysis-and-Classification-main\Customer-Churn-Analysis-and-Classification-main\model.sav", 'rb'))
